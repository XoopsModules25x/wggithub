		...
		<tbody>
			...
			<tr class='<{cycle values='odd, even'}>'>
				...
				<td class="center  width5">
					<a href="directories.php?op=readgh&amp;dir_id=<{$directory.id}>" title="<{$smarty.const._MA_WGGITHUB_READGH_DIRECTORY}>"><img src="<{$wggithub_icons_url_16}>/github.png" alt="<{$smarty.const._MA_WGGITHUB_READGH_DIRECTORY}> directories" /></a>
