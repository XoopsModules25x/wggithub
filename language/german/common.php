...
\define('CO_' . $moduleDirNameUpper . '_' . 'SAVE_SAMPLEDATA_SUCCESS', 'Exportieren Tabellen nach YAML erfolgreich');
\define('CO_' . $moduleDirNameUpper . '_' . 'SAVE_SAMPLEDATA_ERROR', 'ERROR: Exportieren Tabellen nach YAML fehlgeschlagen');
