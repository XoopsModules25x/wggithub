...
<{if $directoriesCount|default:0 > 0}>
	...
	<ul class="nav nav-tabs">
		<li class="nav-item"><a class="nav-link <{if $menu == 0}>active<{/if}>" data-toggle="tab" onclick='javascript:toggleFilters(0)' href="#home"><{$smarty.const._MA_WGGITHUB_INDEX}></a></li>
					...
					<div class="tab-content">
						<{foreach name=repo item=repo from=$directory.repos}>
							<div class="tab-pane fade <{if $smarty.foreach.repo.first}>active show<{/if}>" id="tabdetail<{$repo.id}>" role="tabpanel">
								...
								<div class="cod-xs-12 col-sm-12 tabcontent-headline">
