...
class AmpListener implements EventListener
{
    ...
    {
        $this->info['start_time'] = $this->info['start_time'] ?? micro\time(true);
        ($this->onProgress)();
    ...
    public function startSendingRequest(Request $request, Stream $stream): Promise
    {
        ...
        $this->info['pretransfer_time'] = micro\time(true) - $this->info['start_time'];
    ...
    {
        $this->info['starttransfer_time'] = micro\time(true) - $this->info['start_time'];
        ($this->onProgress)();
    ...
    {
        $this->info['namelookup_time'] = micro\time(true) - $this->info['start_time'];
        ($this->onProgress)();
    ...
    {
        $this->info['connect_time'] = micro\time(true) - $this->info['start_time'];
        ($this->onProgress)();
